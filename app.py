...
st.info(
    "This dashboard shows how Microsoft performed over time. "
    "You do not need finance experience to use it. "
    "Revenue means money coming in, net income means profit left over, "
    "and free cash flow means cash left after major business spending."
)
...
with col1:
    ...
    st.caption("Money Microsoft brought in from sales and services.")
...
with col2:
    ...
    st.caption("Final profit after all costs are paid.")
...
with col3:
    ...
    st.caption("Cash left after running the business and investing in it.")
...
with col4:
    ...
    st.caption("How much profit Microsoft makes from shareholder money.")
...
st.markdown(
    ...
    **How to read this table:**  
    - Higher revenue growth usually means the business is expanding.  
    - Higher margins usually mean better profitability.  
    - A current ratio above 1 often suggests the company can cover short-term bills.  
    - A very high debt-to-equity ratio can mean more financial risk.  
    """
)
